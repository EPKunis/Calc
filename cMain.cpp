...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "Calculator", wxPoint(30, 30), wxSize(800, 600))
{
	...
	Plus_btn = BF.Creation(this, 14, "+", 160, 140);
	...
	Minus_btn = BF.Creation(this, 15, "-", 160, 200);

	//row 3
	Seven_btn = BF.Creation(this, 7, "7", 10, 260);
	Eight_btn = BF.Creation(this, 8, "8", 60, 260);
	Nine_btn = BF.Creation(this, 9, "9", 110, 260);
	Mult_btn = BF.Creation(this, 16, "*", 160, 260);

	//row 4
	Neg_btn = BF.Creation(this, 19, "+/-", 10, 320);
	Zero_btn = BF.Creation(this,0, "0", 60, 320);
	Div_btn = BF.Creation(this, 17, "/", 110, 320);
	Equal_btn = BF.Creation(this, 10,"=", 160, 320);

	//row5 
	Mod_btn = BF.Creation(this, 18, "Mod", 10, 380);
	Bin_btn = BF.Creation(this, 11, "Bin", 60, 380);
	Hex_btn = BF.Creation(this, 12, "Hex", 110, 380);
	Dec_btn = BF.Creation(this, 13, "Dec", 160, 380);
