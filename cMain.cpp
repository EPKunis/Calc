...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "Calculator", wxPoint(30, 30), wxSize(800, 600))
{
	...
	Zero_btn = new wxButton(this, 10010, "+", wxPoint(160, 140), wxSize(50, 50));
	Plus_btn = new wxButton(this, 10011, "0", wxPoint(60, 320), wxSize(50, 50));
	Minus_btn = new wxButton(this, 10012, "-", wxPoint(160, 200), wxSize(50, 50));
	Mult_btn = new wxButton(this, 10013, "=", wxPoint(160, 320), wxSize(50, 50));
	Div_btn = new wxButton(this, 10014, "C", wxPoint(10, 320), wxSize(50, 50));
	Equal_btn = new wxButton(this, 10015, "MOD", wxPoint(160, 380), wxSize(50, 50));
	Clear_btn = new wxButton(this, 10016, "/", wxPoint(160, 260), wxSize(50, 50));
	Mod_btn = new wxButton(this, 10017, "BIN", wxPoint(60, 380), wxSize(50, 50));
	Bin_btn = new wxButton(this, 10018, "HEX", wxPoint(110, 380), wxSize(50, 50));
	Hex_btn = new wxButton(this, 10019, "DEC", wxPoint(10, 380), wxSize(50, 50));
	Dec_btn = new wxButton(this, 10020, "*", wxPoint(110, 320), wxSize(50, 50));
